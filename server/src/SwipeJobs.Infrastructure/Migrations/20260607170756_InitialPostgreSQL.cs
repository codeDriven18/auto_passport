        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalIdentifier = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applications_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyFollows_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedCompanyId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedJobs_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserActivities_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_UserActivities_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    PreferredCategoriesJson = table.Column<string>(type: "text", nullable: false),
                    PreferredTechnologiesJson = table.Column<string>(type: "text", nullable: false),
                    PreferredCitiesJson = table.Column<string>(type: "text", nullable: false),
                    PreferredSalaryMin = table.Column<decimal>(type: "numeric", nullable: true),
                    PreferredSalaryMax = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserInterestProfiles_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyFollows_UserProfileId_CompanyId",
                table: "CompanyFollows",
                columns: new[] { "UserProfileId", "CompanyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedJobs_UserProfileId_JobId",
                table: "SavedJobs",
                columns: new[] { "UserProfileId", "JobId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_ActivityType_CompanyId",
                table: "UserActivities",
                columns: new[] { "ActivityType", "CompanyId" });

            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_ActivityType_JobId",
                table: "UserActivities",
                columns: new[] { "ActivityType", "JobId" });

            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_CompanyId",
                table: "UserActivities",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_JobId",
                table: "UserActivities",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActivities_UserProfileId_OccurredAt",
                table: "UserActivities",
                columns: new[] { "UserProfileId", "OccurredAt" });

            migrationBuilder.CreateIndex(
                name: "IX_UserInterestProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_ExternalUserId",
                table: "UserProfiles",
